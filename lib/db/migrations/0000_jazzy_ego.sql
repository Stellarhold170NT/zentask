...
ALTER TABLE "vault_versions" ADD CONSTRAINT "vault_versions_vault_entry_id_vault_entries_id_fk" FOREIGN KEY ("vault_entry_id") REFERENCES "public"."vault_entries"("id") ON DELETE cascade ON UPDATE no action;